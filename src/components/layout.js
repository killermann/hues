    ...
    <React.Fragment>
      <FadingHeader pose={transitionStatus} style={{
        ...
        <AniLink
          ...
          <nav>
            <AniLink title="Art" style={{fontSize: "calc(1rem + 1vw)", padding: ".5em", lineHeight: "1", textDecoration: "none", color: "#FFC033"}} paintDrip hex="#FFC033" to={`/art/`} duration={.7}>
            ...
            <AniLink title="Tools" style={{fontSize: "calc(1rem + 1vw)", padding: ".5em", lineHeight: "1", textDecoration: "none", color: "#FF40DA"}} paintDrip hex="#FF40DA" to={`/tools/`} duration={.7}>
            ...
            <AniLink title="Resources" style={{fontSize: "calc(1rem + 1vw)", padding: ".5em", lineHeight: "1", textDecoration: "none", color: "#42c0ff"}} paintDrip hex="#42c0ff" to={`/resources/`} duration={.7}>
            ...
            <AniLink title="About" style={{fontSize: "calc(1rem + 1vw)", padding: ".5em", lineHeight: "1", textDecoration: "none", color: "#000"}} paintDrip hex="#000" to={`/about/`} duration={.7}>
